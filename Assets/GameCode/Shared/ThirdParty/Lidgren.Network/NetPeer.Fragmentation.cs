...
namespace Lidgren.Network
{
	...
	public partial class NetPeer
	{
		...
		{
			// Note: this group entityId is PER SENDING/NetPeer; ie. same entityId is sent to all recipients;
			// this should be ok however; as long as recipients differentiate between same entityId but different sender
