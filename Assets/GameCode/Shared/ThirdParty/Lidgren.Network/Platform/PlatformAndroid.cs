...
namespace Lidgren.Network
{
	public static partial class NetUtility
	{
		...
		public static IPAddress GetMyAddress(out IPAddress mask)
		{
			...
			try
			{
				Android.NetAPI.Wifi.WifiManager wifi = (Android.NetAPI.Wifi.WifiManager)Android.App.Application.Context.GetSystemService(Android.App.Activity.WifiService);
