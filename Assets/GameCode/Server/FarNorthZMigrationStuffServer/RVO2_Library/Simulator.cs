    ...
    public class Simulator
    {
        ...
        private class Worker
        {
            ...
            internal void step(object obj)
            {
                ...
                {
                    if (agentNo < 0 || agentNo >= Simulator.Instance.agents_.Count || !AgentSimulationSystem.Instance.Agents[agentNo].active ||
                        AgentSimulationSystem.Instance.HasCooldown(AgentSimulationSystem.Instance.Agents[agentNo])) continue;
            ...
            internal void update(object obj)
            {
                for (int agentNo = start_; agentNo < end_; ++agentNo)
                {
                    if (agentNo < 0 || agentNo >= Simulator.Instance.agents_.Count 
                                    || !AgentSimulationSystem.Instance.Agents[agentNo].active
                                    || AgentSimulationSystem.Instance.HasCooldown(AgentSimulationSystem.Instance.Agents[agentNo]))
                    {
                        continue;
                    }
        ...
        public IList<Obstacle> obstacles_;
         ...
         * <param name="agentRadius">The agentRadius of this agent. Must be non-negative.
         * </param>
         ...
         * </remarks>
         */
        public Obstacle addObstacle(IList<Vector2> vertices)
        {
            if (vertices.Count < 2)
            {
                return null;
        ...
        public float doStep()
        {
            ...
            else
            {
                for (int block = 0; block < workers_.Length; ++block)
                {
                    workers_[block].start_ = block * getNumAgents() / workers_.Length;
                    workers_[block].end_ = (block + 1) * getNumAgents() / workers_.Length;
                }
            }
        ...
        /**
         * <summary>Returns the agentRadius of a specified agent.</summary>
         *
         * <returns>The present agentRadius of the agent.</returns>
         *
         * <param name="agentNo">The number of the agent whose agentRadius is to be
         * retrieved.</param>
         */
         ...
         * less freedom the agent has in choosing its velocities. Must be
         * positive.</param>
         * <param name="agentRadius">The default agentRadius of a new agent. Must be
         * non-negative.</param>
        ...
        /**
         * <summary>Sets the agentRadius of a specified agent.</summary>
         *
         * <param name="agentNo">The number of the agent whose agentRadius is to be
         * modified.</param>
         * <param name="agentRadius">The replacement agentRadius. Must be non-negative.
         * </param>
         */
